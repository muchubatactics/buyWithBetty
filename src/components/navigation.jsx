...
export default function Navigation() {
  ...
  return (
    <div className={styles.navigation}>
      <p>New Releases</p>
      <Link to='games/Last 30 days' className={styles.selected}>
        <div>
      ...
      <p>Top</p>
      <Link to='games/Best of the year'>
        <div>
      ...
      <Link to={'games/Popular in ' + String(d.getFullYear() - 1)} >
        <div>
