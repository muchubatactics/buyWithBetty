...
export default function Navigation({ mobcb }) {
  ...
  return (
    <div className={styles.navigation}>
      <p>New Releases</p>
      <Link to='/shop/games/p' state={{name: 'Last 30 days', type: 'date'}} className={selected == 'Last 30 days' ? styles.selected : ''} onClick={(e) => { e.stopPropagation();handleClick('Last 30 days') }}>
        <div>
      ...
      <Link to='/shop/games/p' state={{name: 'This week', type: 'date'}} className={selected == 'This week' ? styles.selected : ''} onClick={(e) => { e.stopPropagation();handleClick('This week') }}>
        <div>
      ...
      <Link to='/shop/games/p' state={{name: 'Next week', type: 'date'}} className={selected == 'Next week' ? styles.selected : ''} onClick={(e) => { e.stopPropagation();handleClick('Next week') }}>
        <div>
      ...
      <p>Top</p>
      <Link to='/shop/games/p'  state={{name: 'Best of the year', type: 'date'}} className={selected == 'Best of the year' ? styles.selected : ''} onClick={(e) => { e.stopPropagation(); handleClick('Best of the year') }}>
        <div>
      ...
      <Link to='/shop/games/p' state={{name: 'Popular in ' + String(res.date.getFullYear() - 1), type: 'date'}} className={selected == 'Popular' ? styles.selected : ''} onClick={ (e) => {e.stopPropagation(); handleClick('Popular') }}>
        <div>
      ...
      <Link to='/shop/games/p' state={{name: 'All time top', type: 'other'}} className={selected == 'All time top' ? styles.selected : ''} onClick={(e) => { e.stopPropagation(); handleClick('All time top') }}>
        <div>
  ...
  
      {
        res.platforms.map((platform) => {
          ...
          return (
            <Link to='/shop/games/p' state={{name: platform.name, type: 'platform', id: platform.id}} className={selected == platform.name ? styles.selected : ''} onClick={(e) => { e.stopPropagation(); handleClick(platform.name) }} key={platform.id}>
              <div>
                {
                  platform.icon
                }
...

      {
        res.genres.map((genre) => {
          ...
          return (
            <Link to='/shop/games/p'  state={{name: genre.name, type: 'genre', id: genre.id}} className={selected === genre.name ? styles.selected : ''} onClick={(e) => { e.stopPropagation(); handleClick(genre.name) }} key={genre.id}>
              <div>
